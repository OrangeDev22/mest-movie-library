...
export type GetOneMmovieQuery = { __typename?: 'Query', getOneMmovie: { __typename?: 'MovieResponseType', id: string, adult: boolean, backdrop_path: string, title: string, original_language: string, original_title: string, overview: string, poster_path: string, media_type: string, genre_ids?: Array<string> | null, popularity?: number | null, release_date?: string | null, video: boolean, vote_average: number, vote_count: number, production_companies?: Array<{ __typename?: 'ProductionCompany', id: string, name: string }> | null, genres?: Array<{ __typename?: 'Genre', id: string, name: string }> | null } };
